...
java -jar /usr/local/lib/antlr-4.7.1-complete.jar -o python2 -listener -Dlanguage=Python2 MySqlLexer.g4
java -jar /usr/local/lib/antlr-4.7.1-complete.jar -o python2 -listener -Dlanguage=Python2 MySqlParser.g4
